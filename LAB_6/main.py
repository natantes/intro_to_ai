...
def run_experiment(data, value_gold, p_gold, values_gold, delivery_fee, battery_drop_cost, dronerepair_cost, discount_per_cycle):
	...
	if withinprc ( value,value_gold,.01):
		print ("Delivery job value: "+bcolors.GREEN+"SUCCESS"+bcolors.NORMAL+")",value)
	else:
		print ("Delivery job value: "+bcolors.RED+"FAIL"+bcolors.NORMAL,value," - correct value ",value_gold)
		result=False
	return result
...
print("Map1:");
all_passed = run_experiment(data1, 47.06, p_gold1, values_gold1, 100, 1, 100, .95) and all_passed
print
